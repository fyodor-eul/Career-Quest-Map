...
player_img_right = load_img(
    "images/warrior-Right.png", (PLAYER_WIDTH, PLAYER_HEIGHT))
player_img_left = load_img("images/warriorLeft.png",
                           (PLAYER_WIDTH, PLAYER_HEIGHT))
player_img_jump_right = load_img(
    "images/warrior-Right.png", (PLAYER_WIDTH, PLAYER_HEIGHT))
player_img_jump_left = load_img(
    "images/warriorLeft.png", (PLAYER_WIDTH, PLAYER_HEIGHT))
floor_tile_img = load_img("images/floor-tile.png", (TILE_SIZE, TILE_SIZE))
enemy_img_right = load_img("images/kirby_right.png", (ENEMY_SIZE, ENEMY_SIZE))
enemy_img_left = load_img("images/kirby_left.png", (ENEMY_SIZE, ENEMY_SIZE))
...
class Player(pygame.Rect):
    def __init__(self):
        pygame.Rect.__init__(self, PLAYER_X, PLAYER_Y,
                             PLAYER_WIDTH, PLAYER_HEIGHT)
...
def draw():
    ...
    for i in range(player.health):
        screen.blit(health_img, (20 + i*(HEALTH_SIZE+5),
                    20, HEALTH_SIZE, HEALTH_SIZE))
